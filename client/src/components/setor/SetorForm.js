...
class SetorForm extends Component {
    ...
    onCancel(e){
        ...
        let fields = {nome:'', descricao:''}
        this.setState({ fields }) 
        //setTimeout(() => this.props.history.push('/setores'),2000)
            ...
            <main role="main" className="mt-3 flex-shrink-0">
                <div className="container">
                        ...
                        <h1 className="page-header ">
                                <i className="far fa-list-alt"></i> Formulário de Cadastro de Setores
                        </h1>
                         ...
                         rows="5"
                          className="form-control form-control-lg"
                           ...
                           <div className="help-block">{errors.descricao}</div>
                            ...
                            <a className="btn btn-danger" href="/setores" >Cancelar</a>
                            </form>
                            </div>
                            </div>
                        </div>
